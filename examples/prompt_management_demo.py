"""
Demo of the prompt management system for Outlook Extract.

This script demonstrates how to use the prompt management system to track,
version, and test prompts used in the application.
"""
import os
import sys
...
def main():
    """Run the prompt management demo."""
    print("=== Outlook Extract - Prompt Management Demo ===\n")
    
    # Show the current prompt configuration
    config = get_prompt_config()
    print("Current prompt configuration:")
    print(json.dumps(config['prompts'], indent=2))
